...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("Example: python3 getpapers-openalex.py rfs 2024")
        sys.exit(1)
    ...
    filters = get_filters(journal_key, year)
    ...
    if articles:
        ...
        db_filename = f'openalex_{journal_key}_{year}.db'
