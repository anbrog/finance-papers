...
2. Ranks authors and displays top 250
3. Optionally generates author list CSV
4. Prompts whether to update working papers (y/n)
5. Displays working papers rankings
